...
qwords = ["Что", "Чем", "Где", "Когда", "Кто", "Кем", "Кому", "Почему", "Зачем", "Как", "Какой", "Какая", "Какое", "Каким"]
...
def main():
    #event = json.loads('{     "type":"sq_question",   "owner_id":-162894513,   "video_id":456239000,   "question":{        "id":11,      "text":"Какой из фруктов обладает свойством разрушения животного белка?",      "answers":[           {              "id":0,            "text":"Папайя"         },         {              "id":1,            "text":"Ананас"         },         {              "id":2,            "text":"Манго"         }      ],      "time":null,      "number":1   },   "version":2}')
